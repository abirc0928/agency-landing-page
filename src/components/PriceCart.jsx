...
import PriceDetielsItem from './PriceDetielsItem'
import { PriceTickSVG } from './SVG/PriceTickSVG'


const PriceCart = ({ tittle, description, price, priceDetiels }) => {
    return (
        <div
            ...
            <h3 class="mb-4 text-2xl font-semibold">{tittle}</h3>
            ...
            <ul role="list" class="mb-8 space-y-4 text-left">
                {
                    priceDetiels.map((item)=><PriceDetielsItem item={item}></PriceDetielsItem>)
                }
            </ul>
            <a href="#"
